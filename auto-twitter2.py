...
tweetButton = browser.find_element_by_css_selector(
    "span.r-1inkyih:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)"
).click()
...
ActionChains(browser).move_to_element(writing_tweet).click(writing_tweet).send_keys(
    tweet
).perform()

send_tweet = browser.find_element_by_css_selector(
    "div.r-l5o3uw:nth-child(4) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)"
).click()
